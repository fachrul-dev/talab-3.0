...
$userRole = Auth::user()->role; // Ganti dengan kode yang sesuai untuk mendapatkan role user yang login
    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="#"><img src="{{ asset('talab-icon.png') }}" width="80%" alt="Logo" srcset=""></a>
                </div>
